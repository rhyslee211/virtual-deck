        ...
        <div className="w-16 bg-slate-800 h-full">
            <div className="flex flex-col items-center justify-between h-full">
                <div className="flex flex-col items-center">
                    <button className={`w-12 h-12 mt-4 mb-4 bg-indigo-400 rounded-full flex items-center justify-center hover:bg-indigo-500 ${isFormVisible ? 'border-2 border-white' : ''}`} onClick={onFormButtonClick}><FaPlus size={24} /></button>
                    ...
                    <button className={`w-12 h-12 mb-4 bg-indigo-400 rounded-full flex items-center justify-center hover:bg-indigo-500 ${isInSettings ? 'border-2 border-white' : ''}`} onClick={onSettingsButtonClick}><IoMdSettings size={24} /></button>
                </div>
                <div className="flex flex-col items-center">
