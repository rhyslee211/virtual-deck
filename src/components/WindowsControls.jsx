    ...
    return (
        <div className="top-0 left-0 w-full bg-slate-900 flex flex-row justify-between">
            ...
            <div className="flex justify-end items-center w-fit">
                ...
                {!isMaximized && <button className="text-white px-4 py-2 w-fit h-fit hover:bg-slate-700" onClick={() => controlWindow('maximize')}>
                ...
                {isMaximized && <button className="text-white px-4 py-2 w-fit h-fit hover:bg-slate-700" onClick={() => controlWindow('resize')}>
                ...
                <button className="text-white px-4 py-2 w-fit h-fit hover:bg-red-600" onClick={() => controlWindow('close')}>
